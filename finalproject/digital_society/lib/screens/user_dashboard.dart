...
class _UserDashboardState extends State<UserDashboard> {
  ...
  List eventColors = [Colors.pink.shade100];
  ...
  void fetchMaintenance() async {
    ...
    if (json['status'] == "success") {
      ...
      for (var item in data) {
        ...
        if (item['status'] == "unpaid" || item['status'] == "due") {
      ...
      setState(() => isMaintenanceLoading = false);
    }
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(date, style: TextStyle(color: Colors.white70, fontSize: 25)),
          ],
        ),
      ),
    );
