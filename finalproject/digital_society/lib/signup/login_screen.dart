...
class _AdminLoginScreenState extends State<userLoginScreen> {
  ...
  void check_if_already_login() async {
    ...
    if (prefs.getBool('admin') ?? false) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => UserDashboard(userName: _usernameController.text,)),
      );
    }
  }
                              ...
                              children: [
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => chengePassword()),
                                    );
                                  },
                                  child: const Text(
                                    "Signup here",
