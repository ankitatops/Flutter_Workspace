  ...
  Future updateStatus(String id, String status) async {
    ...
    if (data["status"] == "success") {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Problem Status Updated")));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading
          ...
          : RefreshIndicator(
              onRefresh: getProblems, // 🔥 important
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              String newStatus = problem["status"] == "open"
                                  ? "closed"
                                  : "open";
                            ...
                            child: Text(
                              problem["status"] == "open" ? "Close" : "Open",
                            ),
                          ),
                        ),
                      ],
