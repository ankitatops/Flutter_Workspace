              ...
              GridView.count(
                ...
                children: [
                  dashboardCard("Maintenance", Icons.build,
                      [Colors.teal, Colors.cyan], const MaintenanceScreen()),
                  dashboardCard("Events", Icons.event,
                      [Colors.indigo, Colors.blue], const EventsPage()),
                  dashboardCard("Notices", Icons.campaign,
                      [Colors.purple, Colors.pink], const Notice()),
                  dashboardCard("Staff", Icons.people,
                      [Colors.blue, Colors.lightBlue], const staff()),
                ],
              ),
