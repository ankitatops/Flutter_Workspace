...
class AdminHomePage extends State<Home> {
  Future<List> viewCategoryData() async {
    final responce = await http.get(
      Uri.parse("https://prakrutitech.xyz/FlutterProject/category_view.php"),
    );
...
class _Items extends State<Items> {
  ...
  //     "https://amisha1299.000webhostapp.com/Ewishes/upload_category_main_image_update.php";
  // final ImagePicker _picker = ImagePicker();

  void deleteCategory(var id) {
    var url = "https://prakrutitech.xyz/FlutterProject/category_delete.php";
    http.post(Uri.parse(url), body: {'data': id});
  }

  void deleteCategoryImages(var id) {
    var url =
        "https://prakrutitech.xyz/FlutterProject/category_images_delete.php";
    http.post(Uri.parse(url), body: {'data': id});
  }
  ...
  void updateCategoryName(var id) {
    ...
    http.post(
      Uri.parse(url),
      body: {'id': id, 'category_name': update_category.text.toString()},
    );
  }
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    title: Row(
                      children: [
                        ...
                        Text("\tDelete", style: TextStyle(color: kBrown)),
                      ],
                    ),
                    content: Text(
            ...
            title: Row(
              children: [
                SizedBox(
                  ...
                  child: Text(
                    "${list_[index]['category_name']}".toUpperCase(),
                    style: TextStyle(
                      color: kDarkBrown,
                      fontStyle: FontStyle.italic,
                      fontSize: 15,
                  ...
                  onTap: () {
                    ...
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        title: Row(
                          children: [
                            Icon(Icons.update, color: kBrown),
                            Text(
                              "\tUpdate Category",
