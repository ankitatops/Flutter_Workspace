...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget divider() {
    return Divider(color: Colors.white12, height: 25.h);
  }
  ...
  Widget switchTile(
    ...
    return Row(
      children: [
        ...
        Switch(value: value, activeColor: green, onChanged: onChanged),
      ],
    );
  }

  Widget arrowTile(IconData icon, String title, String sub) {
    return Row(
      children: [
        iconBox(icon),
