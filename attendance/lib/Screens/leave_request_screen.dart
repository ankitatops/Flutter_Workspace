  ...
  Future<void> _selectDate(bool isStart) async {
    ...
    if (picked != null) {
      setState(() {
        if (isStart) {
          startDate = picked;
          // Start date change thay to invalid endDate clear karo
          ...
          if (startDate != null && picked.isBefore(startDate!)) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("End date, start date thi pehli ન હોઈ શકે")),
            );
            return;
          }
          endDate = picked;
  ...
  Future<void> _submit() async {
    ...
    try {
      await ApiService.submitLeaveRequest(
        reason: selectedCategory, // backend mate lowercase: vacation/sick/personal
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      // TODO: Full leave history screen par navigate karo
                    },
              ...
              if (isLoading)
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: _loadRequests,
                        child: const Text("Retry", style: TextStyle(color: primaryGreen, fontSize: 12)),
                      ),
                    ],
                  ),
                )
                ...
                Column(
                  children: [
                    activity("VACATION", "Pending"), // dummy 1
                    activity("Sick Leave", "Pending"), // dummy 2
                  ],
                )
              else
