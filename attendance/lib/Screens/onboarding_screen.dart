  ...
  final List<Map<String, dynamic>> _slides = [
    {
      ...
      'desc': "Mark attendance instantly with AI-powered face recognition. No more manual entries."
    },
    {
      'icon': Icons.bar_chart_rounded,
      'title': "Leave & Reports",
      'desc': "Apply for leaves and view detailed attendance analytics right from your phone."
    },
    {
      'icon': Icons.notifications_active_rounded,
      'title': "Stay Notified",
      'desc': "Get real-time alerts, calendar updates, and never miss an important attendance event."
    },
  ];
                  ...
                  Row(
                    ...
                    children: List.generate(_slides.length, (index) {
                      ...
                      return AnimatedContainer(
                        ...
                        height: 8.h,
                        decoration: BoxDecoration(
                          color: isActive ? const Color(0xFF8CC63F) : Colors.white24,
